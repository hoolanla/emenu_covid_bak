...
class MainLoginState extends State<MainLogin> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
        appBar: new AppBar(title: new Text("Covid Food"), backgroundColor: Colors.green),
        body: new Container(
            child: new Center(
                child: new Column(
...
//                height: 240.0,
                      ...
                      new RaisedButton(
                          child: new Text("เข้าระบบร้านค้า", style: new TextStyle(color: Colors.white, fontStyle: FontStyle.italic, fontSize: 20.0)),
                          color: Colors.green,
                      ...
                      new Padding(padding: new EdgeInsets.all(10.0)),
                      new RaisedButton(
                          child: new Text("เข้าระบบผู้สั่งอาหาร", style: new TextStyle(color: Colors.white, fontStyle: FontStyle.italic, fontSize: 20.0)),
                          color: Colors.green,
